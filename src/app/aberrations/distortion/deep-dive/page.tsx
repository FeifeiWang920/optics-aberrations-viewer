        ...
        >
          ...
          <div className="prose prose-invert prose-lg max-w-none text-slate-300 space-y-12">
            <p className="text-xl text-slate-300 leading-relaxed max-w-4xl p-6 glass rounded-xl border-l-4 border-accent-cyan">
              畸变的本质是：由于<strong className="text-white">孔径光阑</strong>（控制进光量的圆孔挡板）的位置偏离了透镜的光学中心，强迫斜射的宽光束通过时打击在具有强烈球差的透镜边缘区域上，从而导致横向放大率随离轴距离发生了非线性的偏折变态。
            </p>
            ...
            <div className="glass p-8 rounded-xl border border-white/5 bg-slate-900/50">
              ...
              <div className="text-base text-slate-400 mb-8 space-y-4">
                ...
                <p>
                  凸透镜的下半部，其天职就是把光线<strong className="text-accent-cyan">向上弯折</strong>以向光轴聚拢。但透镜边缘存在天然的**球差（折光力远超中心）**！因此，这束本该投射到下方边缘的光线，被严重超标的折光力“<strong className="text-white">向上过度往回拉了一把</strong>”。
                </p>
                <p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-stretch">
                  <div className="lg:col-span-3 flex flex-col glass rounded-xl border border-white/5 p-6">
                    ...
                    <div className="flex-grow">
                      <RayCanvas aberrationType="distortion" parameter={-1} rayCount={5} />
                    </div>
                  </div>
                  <div className="lg:col-span-2">
                      <AberrationVisuals aberrationType="distortion" parameter={-1} />
                  </div>
              </div>
            </div>
            ...
            <div className="glass p-8 rounded-xl border border-white/5 bg-accent-purple/5">
              ...
              <div className="text-base text-slate-300 mb-8 space-y-4">
                <p>
                  而当光阑<strong className="text-accent-purple">后置</strong>时，几何关系发生了绝妙的反转！同样是一束<strong className="text-white">斜向下方</strong>射入视野的平行光集群，如果它们打在透镜下半部分，经过折射后早就过度偏离，**根本无法钻进后方那个狭小的光阑洞口。**
                </p>
                <p>
                  **真正能幸存穿过孔洞的光线，入射时必须极度反常地打击在透镜的<strong className="text-accent-purple pl-1 text-xl">上半部分</strong>！**
                </p>
                <p>
